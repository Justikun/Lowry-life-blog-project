...
homeButton.addEventListener('click', (getHomePosts))

const makePostCard = () => {
    // let post = document.createElement('div')
    // post.setAttribute('class', 'main-content__container')
    // post.innerHTML = document.getElementByClass('post-snip__template').innerHTML
...
const renderHomePosts = () => {
    ...
    mainContentContainer.innerHTML += makePostCard()
}
